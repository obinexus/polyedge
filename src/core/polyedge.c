/**
 * PolyEdge: Core Computational Membrane Header
 * 
 * Defines the foundational interfaces for computational consciousness
 */
#ifndef POLYEDGE_CORE_H
#define POLYEDGE_CORE_H
